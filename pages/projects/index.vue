...
<template>
  ...
  <CSection title="Mods" description="ゲームのMOD" header-align="center" title-font="inter">
    <div class="flex flex-col items-center my-10px">
      <CInfoCard logo="/images/logos/axuata/project-logos/vanilla_plus/logo.svg" title="Vanilla Plus" description="⚔️ Vanilla Plus mod for Hearts of Iron 4" link="https://github.com/axuata/vanilla_plus" />
    </div>
  </CSection>
  <CSection title="Others" description="その他" header-align="center" title-font="inter">
    <div class="flex flex-col items-center my-10px">
      <CInfoCard logo="/images/logos/axuata/project-logos/assets/logo.svg" title="Assets" description="🗂️ Static Assets Repository by Axuata" link="https://github.com/axuata/assets" />
    </div>
  </CSection>
</template>
